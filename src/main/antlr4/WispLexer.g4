...
fragment HEX_COLOR_SHORT		: HEX HEX HEX;
fragment HEX_COLOR_SHORT_ALPHA	: HEX_COLOR_SHORT HEX;
fragment HEX_COLOR_FULL			: HEX_COLOR_SHORT HEX_COLOR_SHORT;
fragment HEX_COLOR_FULL_ALPHA	: HEX_COLOR_FULL HEX HEX;

HEX_COLOR: '#' ( HEX_COLOR_SHORT | HEX_COLOR_SHORT_ALPHA | HEX_COLOR_FULL | HEX_COLOR_FULL_ALPHA);
